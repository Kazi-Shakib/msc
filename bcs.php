...
<table width="760" border="0" align="center" cellpadding="0" cellspacing="0">l
  <tbody><tr>
			...
			<td bgcolor="#49575f" height="120"><table width="100%" border="0" cellpadding="3" cellspacing="0" class="black12">
			  <tbody><tr>
				...
				<td width="80%" align="center" valign="middle">
				 	...
				 	<font color="white"><font size="6"><b> Bangladesh Computer Society Membership Registration </b></font><br>
				 	 
					<font color="white"><font size="2"><b><a href="http://cuet.xyz/" target="_blank"><mark>www.bcsbd.org.bd<mark></mark></mark></a></b></font><br>
        ...
        <tbody><tr bgcolor="#A2A2A2">
          ...
          <td width="70%" height="35" align="left" valign="middle">
			  <table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tbody><tr>
					<td width="60%" align="left" valign="middle" class="black12">Membership Registration </td>
					<td width="23%" height="35" align="left" valign="middle">Have to pay 5000 BDT for Fellow and 6000 BDT for Member <br>
 <br></td>
</hr>
				  </tr>
			  </tbody></table>
		  ...
		  <input type="hidden" name="post_code" id="post_code" value="200">
                        ...
                        <tr>
                          <td align="left" valign="middle" bgcolor="#E3E3E3" class="black12">Name of the Memebrship</td>
...
<tr>
  ...
  <tr>
    <td height="25" align="center" valign="middle" bgcolor="lightgreen" class="black10"><font size="1"><b><i>For any inconvenience, please send email to  bcsbd</i></b></font></td>
  </tr>
  <tr>
    <td align="left" valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td align="left" valign="top"><fieldset>
      <table width="100%" border="0" cellpadding="0" cellspacing="0" class="black10">
        <tbody><tr>
          <td width="1%" align="left" valign="middle">&nbsp;</td>
          <td width="80%" align="left" valign="middle"><tt>©2020 BCSBD.</tt></td>
